...
@Component({
  ...
  imports: [TabsModule, TranslateModule, AccountVisuals, AccountAppearence, AccountSecurity, AccountBasicInformation],
...
export class AccountMain {
  public readonly tabs = [
    ...
    { title: 'security.label', value: '2', icon: 'ph ph-lock', description: 'security.description' },
  ];
}
